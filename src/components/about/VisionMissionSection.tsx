              ...
              >
                <div className="h-80 flex items-center justify-center">
                  <div className="relative w-full h-full flex items-center justify-center">
                    ...
                    <motion.div
                          className="absolute -top-2 -left-2 w-20 h-20 border-t-4 border-l-4 border-[var(--color-primary)] rounded-tl-3xl opacity-60"
                          animate={{
                    ...
                    />
                    <motion.div
                          className="absolute -top-2 -right-2 w-20 h-20 border-t-4 border-r-4 border-[var(--color-primary)] rounded-tr-3xl opacity-60"
                          animate={{
                            borderColor: ["var(--color-primary)", "#f15a22", "var(--color-primary)"]
                          }}
                          transition={{
                    ...
                    />
                    <motion.div
                          className="absolute -bottom-2 -left-2 w-20 h-20 border-b-4 border-l-4 border-[var(--color-primary)] rounded-bl-3xl opacity-60"
                          animate={{
                            borderColor: ["var(--color-primary)", "#f15a22", "var(--color-primary)"]
                          }}
                          transition={{
                    ...
                    />
                    <motion.div
                          className="absolute -bottom-2 -right-2 w-20 h-20 border-b-4 border-r-4 border-[var(--color-primary)] rounded-br-3xl opacity-60"
                          animate={{
                            borderColor: ["var(--color-primary)", "#f15a22", "var(--color-primary)"]
                          }}
                          transition={{
