...
const SolutionsClient = () => {
	return (
		<div className="min-h-screen">
			...
			<section id="solutions" className="py-20 bg-gradient-to-b from-white to-[#743f77] relative overflow-hidden">
				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						<div className="mt-2 inline-block mb-6 px-4 py-1 rounded-full border border-[var(--color-secondary)]/30 bg-[var(--color-secondary)]/10 text-sm font-medium text-[var(--color-secondary)]">
