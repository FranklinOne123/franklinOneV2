						...
						>
							...
							<div className="mb-8">
								<h3 className="text-2xl md:text-3xl font-bold text-white mb-4 flex items-center">
									<motion.span className="bg-gradient-to-r from-white via-[var(--color-primary)] to-white bg-clip-text text-transparent"
									animate={!isMobile && !prefersReducedMotion ? {
										backgroundPosition: ['0% 50%', '100% 50%', '0% 50%']
									} : {}}
									transition={!isMobile && !prefersReducedMotion ? {
										...
										<div className="p-4 bg-gradient-to-br from-gray-700/30 to-gray-800/50 flex items-center justify-center flex-grow relative">
											{vendor.logo ? (
												<div className="relative group/logo">
													...
													{/* thy:remove border border-white/10 */}
													<div className="relative bg-white/5   rounded-lg p-3  group-hover/logo:border-[#c18a41]/50 transition-all duration-300 bg-gradient-to-r to-[#351437] from-[#0f151c] hover:from-[#f15a22] hover:to-[var(--color-primary)]" >
														<Image
															src={vendor.logo}
															alt={vendor.name}
															width={160}
