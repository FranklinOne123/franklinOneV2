...
import VendorSlider from './VendorsSlider';
...
//         logo: '/images/qualys_original.png',
...
//     {
//         name: 'i-PRO',
//         logo: '/images/promon_rainbow_transparent.gif', // You can replace with actual logo path
...
const RedesingVender = () => {
    ...
    return (
        <div className="min-h-screen pt-4">
            ...
            <section className="relative min-h-[85vh] flex items-center pb-4 justify-center bg-[#0a0e1a] text-white overflow-hidden">
                {/* Dark cyber background with overlay */}
                <div className="absolute inset-0 z-0">
                    <motion.div
                        className="absolute inset-0 bg-gradient-to-b from-[rgba(10,14,26,0.95)] via-[rgba(22,33,62,0.85)] to-[#0f0216] z-10"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
                    ...
                    >
                        {[
                            { number: "10+", label: "Partnering with 10+ Technology Partners", color: "#c53fd4", delay: 0 },
                            { number: "✓", label: "Each Holds the Leader Position in the industry", color: "#f15a22", delay: 0.15 },
                            { number: "✓", label: "Trusted by Enterprise Customers Worldwide", color: "#c53fd4", delay: 0.3 },
            ...
            style={{ backgroundImage: "url('/images/vendors_bg_dark.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                {/* Background patterns */}
                <div className="absolute right-0 w-full h-[50px]  top-0 " style={{ boxShadow: '0px -33px 27px #681a77' }} />
                <div className="absolute inset-0">
                    <div
                        className="absolute inset-0 opacity-10 bg-repeat"
                        style={{
                            backgroundImage: `
                                linear-gradient(rgba(224, 211, 225, 0.4) 1px, transparent 1px),
                                linear-gradient(90deg, rgba(169, 124, 171, 0.4) 1px, transparent 1px)
                            `,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        <motion.h2 
                            ...
                            <div className="w-32 h-1 bg-gradient-to-r from-transparent via-[#f15a22] to-transparent rounded-full mx-auto" style={{ opacity: 0.93979 }}></div>
                    </motion.h2>
            ...
            <section className="py-20 bg-gradient-to-b from-[#030007]/100 to-[#723e75]/100 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center">
                        ...
                        >
                            <motion.span
                                className="bg-gradient-to-r from-white via-[#f15a22] to-white bg-clip-text text-transparent"
                                initial={{ backgroundPosition: "0% 50%" }}
                                animate={{ backgroundPosition: "100% 50%" }}
                                transition={{ 
                                  duration: 3,
                                ...
                                style={{ backgroundSize: "200% 200%" }}
                            >Ready to explore our</motion.span>
